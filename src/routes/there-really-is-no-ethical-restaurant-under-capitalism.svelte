<script context="module">
	export const metadata = {"title":"There Really Is No Ethical Restaurant Under Capitalism","slug":"there-really-is-no-ethical-restaurant-under-capitalism","source":"https://www.eater.com/21398969/future-co-op-worker-owned-restaurants-ethical-business","author":"Jaya Saxena","year":2020,"tags":"food, ethics, work","thesis":"Building an equitable restaurant — where all workers are paid fairly, have benefits, and work without discrimination — will require undoing the way most restaurants are run","date":"2020.09.01","type":"annotation, bibliography"};
