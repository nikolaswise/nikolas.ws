...
function drawer () {
  ...
  function openDrawer (options) {
    ...
    if (right) {
      ...
      classy.add(footer, 'drawer-right-is-active');
    } else if (left) {
      classy.add(wrapper, 'drawer-left-is-active');
      classy.add(footer, 'drawer-left-is-active');
    }
  ...
  function closeDrawer (options) {
    ...
    classy.remove(footer, 'drawer-left-is-active');
    classy.remove(wrapper, 'drawer-right-is-active');
    classy.remove(footer, 'drawer-right-is-active');
