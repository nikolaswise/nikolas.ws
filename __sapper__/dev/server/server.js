...
const css$1 = {
	code: "p.svelte-19na9ee{margin-bottom:5rem}date.svelte-19na9ee{margin-bottom:0rem}h2.svelte-19na9ee{margin-top:0.5rem;margin-bottom:1rem}",
	map: "{\"version\":3,\"file\":\"index.svelte\",\"sources\":[\"index.svelte\"],\"sourcesContent\":[\"<script>\\n  import projects from '../../data/projects/index.json'\\n</script>\\n\\n<style>\\n  \\n  p {\\n    margin-bottom: 5rem;\\n  }\\n  date {\\n    margin-bottom: 0rem;\\n  }\\n  h2 {\\n    margin-top: 0.5rem;\\n    margin-bottom: 1rem;\\n  }  \\n</style>\\n\\n<svelte:head>\\n  <title>Projects</title>\\n</svelte:head>\\n\\n<h1>Projects</h1>\\n\\n\\n{#each projects as project}  \\n  <date>{project.meta.date}</date>\\n  <h2>\\n    <a href=\\\"/projects/{project.meta.slug}\\\">\\n      {project.meta.title}\\n    </a>\\n  </h2>\\n  <p>{@html project.meta.description}</p>\\n{/each}\\n\"],\"names\":[],\"mappings\":\"AAME,CAAC,eAAC,CAAC,AACD,aAAa,CAAE,IAAI,AACrB,CAAC,AACD,IAAI,eAAC,CAAC,AACJ,aAAa,CAAE,IAAI,AACrB,CAAC,AACD,EAAE,eAAC,CAAC,AACF,UAAU,CAAE,MAAM,CAClB,aAAa,CAAE,IAAI,AACrB,CAAC\"}"
};
...
${each(projects, project => `<date class="${"svelte-19na9ee"}">${escape(project.meta.date)}</date>
  <h2 class="${"svelte-19na9ee"}"><a href="${"/projects/" + escape(project.meta.slug)}">${escape(project.meta.title)}
    </a></h2>
  <p class="${"svelte-19na9ee"}">${project.meta.description}</p>`)}`;
});

/* src/routes/projects/[slug].svelte generated by Svelte v3.24.0 */

const css$2 = {
	code: "h2.svelte-tom8v2{margin-bottom:2rem;font-style:italic;font-size:var(--s-18);line-height:calc(1em + var(--u-6p))}",
	map: "{\"version\":3,\"file\":\"[slug].svelte\",\"sources\":[\"[slug].svelte\"],\"sourcesContent\":[\"<script context=\\\"module\\\">\\n  import projects from '../../data/projects/index.json'\\n  export async function preload({ params }) {\\n    let slug = params.slug;\\n    let project = projects.find(proj => proj.meta.slug == slug)\\n    return {project}\\n  }\\n</script>\\n\\n<script>\\n  export let project\\n  let title = {project} ? `nikolas.ws: ${project.meta.title}` : 'Project not found.'\\n</script>\\n\\n\\n<style>\\n  h2 {\\n    margin-bottom: 2rem;\\n    font-style: italic;\\n    font-size: var(--s-18);\\n    line-height: calc(1em + var(--u-6p));\\n  }\\n</style>\\n\\n<svelte:head>\\n  <title>{title}</title>\\n</svelte:head>\\n\\n{#if project}\\n  <date>\\n    {project.meta.date}\\n  </date>\\n  <h1>\\n    {project.meta.title}\\n  </h1>\\n\\n  <p>\\n    <a href=\\\"{project.meta.site}\\\">See Live Project</a>\\n  </p>\\n\\n  <h2>\\n    {@html project.meta.description}\\n  </h2>\\n\\n\\n  {@html project.content}\\n{:else}\\n  <h1>404</h1>\\n  <p>That's not a project. <a href=\\\"/projects\\\">See what is.</a></p>\\n{/if}\"],\"names\":[],\"mappings\":\"AAgBE,EAAE,cAAC,CAAC,AACF,aAAa,CAAE,IAAI,CACnB,UAAU,CAAE,MAAM,CAClB,SAAS,CAAE,IAAI,MAAM,CAAC,CACtB,WAAW,CAAE,KAAK,GAAG,CAAC,CAAC,CAAC,IAAI,MAAM,CAAC,CAAC,AACtC,CAAC\"}"
};
...
const css$3 = {
	code: "p.svelte-z41312{margin-bottom:5rem}date.svelte-z41312{margin-bottom:0rem}h2.svelte-z41312{margin-top:0.5rem;margin-bottom:1rem}",
	map: "{\"version\":3,\"file\":\"index.svelte\",\"sources\":[\"index.svelte\"],\"sourcesContent\":[\"<script>\\n  import texts from '../../data/texts/index.json'\\n</script>\\n\\n<style>\\n  \\n  p {\\n    margin-bottom: 5rem;\\n  }\\n  date {\\n    margin-bottom: 0rem;\\n  }\\n  h2 {\\n    margin-top: 0.5rem;\\n    margin-bottom: 1rem;\\n  }\\n</style>\\n\\n<svelte:head>\\n  <title>Texts</title>\\n</svelte:head>\\n\\n<h1>Texts</h1>\\n\\n{#each texts as text}\\n  <date>{text.meta.date}</date>\\n  <h2>\\n    <a href=\\\"/texts/{text.meta.slug}\\\">\\n      {text.meta.title}\\n    </a>\\n  </h2>\\n  <p>{@html text.meta.description}</p>\\n{/each}\\n\"],\"names\":[],\"mappings\":\"AAME,CAAC,cAAC,CAAC,AACD,aAAa,CAAE,IAAI,AACrB,CAAC,AACD,IAAI,cAAC,CAAC,AACJ,aAAa,CAAE,IAAI,AACrB,CAAC,AACD,EAAE,cAAC,CAAC,AACF,UAAU,CAAE,MAAM,CAClB,aAAa,CAAE,IAAI,AACrB,CAAC\"}"
};
...
${each(texts, text => `<date class="${"svelte-z41312"}">${escape(text.meta.date)}</date>
  <h2 class="${"svelte-z41312"}"><a href="${"/texts/" + escape(text.meta.slug)}">${escape(text.meta.title)}
    </a></h2>
  <p class="${"svelte-z41312"}">${text.meta.description}</p>`)}`;
});
...
${text
	? `<date>${escape(text.meta.date)}</date>
  <h1>${escape(text.meta.title)}</h1>

  <h2 class="${"svelte-tom8v2"}">${text.meta.description}</h2>
